...
#### 1. `CLASP_CREDENTIALS`
Install clasp locally (`npm install -g @google/clasp`), log in (`clasp login --no-localhost`), and copy the entire contents of your generated `~/.clasprc.json` file. Paste it as the value for `CLASP_CREDENTIALS`.
